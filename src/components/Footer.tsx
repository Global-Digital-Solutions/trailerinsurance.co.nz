      ...
      <div className="border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <p className="text-xs text-slate-500 leading-relaxed max-w-4xl">
            TrailerInsurance.co.nz is a referral and lead generation service operated by Cover4You — not an insurance underwriter, licensed insurer, or financial adviser. We are not a licensed financial adviser, insurer, or insurance broker. The information on this website is general in nature and does not constitute financial advice or a recommendation to purchase any insurance product. The advisers we refer enquiries to are NZ-licensed financial advisers regulated under the Financial Markets Conduct Act 2013 (FMCA). Before proceeding with any insurance product you will receive a disclosure statement from your adviser outlining their licensing, commissions, and any conflicts of interest. We may receive a referral fee when a policy is arranged — this does not affect the advice you receive or the price you pay.
          </p>
        </div>
      </div>
